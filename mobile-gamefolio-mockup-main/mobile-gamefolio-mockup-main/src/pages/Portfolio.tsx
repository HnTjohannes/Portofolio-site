...
const projects = [
  {
    ...
    tasks: [
      ...
      "Designing and building an interchangeable special ability system allowing for combining different skills so player's can create their own playstyle.",
  ...
  },
  {
    ...
    tasks: [
      ...
      "Making the in-game menu UI functional and later improving it visually with the art team.",
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      "I worked on set dressing. I tried recreating the layout of the area as close to the real one as possible. For this, I looked at satellite pictures and went there in person to get a better understanding of the area.",
      "Because of performance issues, we chose to build the codebase from scratch and also implement things that weren't already there, such as LODs, light baking, and occlusion culling.",
    ],
